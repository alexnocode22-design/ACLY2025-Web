...
class ACLY2025WebSupabaseUser extends BaseAuthUser {
  ACLY2025WebSupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> aCLY2025WebSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = ACLY2025WebSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
