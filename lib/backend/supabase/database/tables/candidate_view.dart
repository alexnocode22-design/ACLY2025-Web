...
class CandidateViewTable extends SupabaseTable<CandidateViewRow> {
  @override
  String get tableName => 'candidate_view';

  @override
  CandidateViewRow createRow(Map<String, dynamic> data) =>
      CandidateViewRow(data);
}

class CandidateViewRow extends SupabaseDataRow {
  CandidateViewRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => CandidateViewTable();
  ...
  int? get trainerProfileId => getField<int>('trainer_profile_id');
  set trainerProfileId(int? value) =>
      setField<int>('trainer_profile_id', value);
  ...
  DateTime? get trainerProfileCreatedAt =>
      getField<DateTime>('trainer_profile_created_at');
  set trainerProfileCreatedAt(DateTime? value) =>
      setField<DateTime>('trainer_profile_created_at', value);
