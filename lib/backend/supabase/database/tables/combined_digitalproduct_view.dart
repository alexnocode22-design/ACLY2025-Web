...
class CombinedDigitalproductViewTable
    extends SupabaseTable<CombinedDigitalproductViewRow> {
  @override
  String get tableName => 'combined_digitalproduct_view';

  @override
  CombinedDigitalproductViewRow createRow(Map<String, dynamic> data) =>
      CombinedDigitalproductViewRow(data);
}

class CombinedDigitalproductViewRow extends SupabaseDataRow {
  CombinedDigitalproductViewRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => CombinedDigitalproductViewTable();
