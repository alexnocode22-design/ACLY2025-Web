...
class CombinedNutritionplansViewTable
    extends SupabaseTable<CombinedNutritionplansViewRow> {
  @override
  String get tableName => 'combined_nutritionplans_view';

  @override
  CombinedNutritionplansViewRow createRow(Map<String, dynamic> data) =>
      CombinedNutritionplansViewRow(data);
}

class CombinedNutritionplansViewRow extends SupabaseDataRow {
  CombinedNutritionplansViewRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => CombinedNutritionplansViewTable();
