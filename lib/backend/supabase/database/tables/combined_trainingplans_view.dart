...
class CombinedTrainingplansViewTable
    extends SupabaseTable<CombinedTrainingplansViewRow> {
  @override
  String get tableName => 'combined_trainingplans_view';

  @override
  CombinedTrainingplansViewRow createRow(Map<String, dynamic> data) =>
      CombinedTrainingplansViewRow(data);
}

class CombinedTrainingplansViewRow extends SupabaseDataRow {
  CombinedTrainingplansViewRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => CombinedTrainingplansViewTable();
