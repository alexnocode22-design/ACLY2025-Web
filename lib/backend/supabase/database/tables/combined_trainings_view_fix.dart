...
class CombinedTrainingsViewFixTable
    extends SupabaseTable<CombinedTrainingsViewFixRow> {
  @override
  String get tableName => 'combined_trainings_view_fix';

  @override
  CombinedTrainingsViewFixRow createRow(Map<String, dynamic> data) =>
      CombinedTrainingsViewFixRow(data);
}

class CombinedTrainingsViewFixRow extends SupabaseDataRow {
  CombinedTrainingsViewFixRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => CombinedTrainingsViewFixTable();
