...
class TrainerProfileTable extends SupabaseTable<TrainerProfileRow> {
  @override
  String get tableName => 'trainer_profile';

  @override
  TrainerProfileRow createRow(Map<String, dynamic> data) =>
      TrainerProfileRow(data);
}

class TrainerProfileRow extends SupabaseDataRow {
  TrainerProfileRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => TrainerProfileTable();
