...
class TrainersViewTable extends SupabaseTable<TrainersViewRow> {
  @override
  String get tableName => 'trainers_view';

  @override
  TrainersViewRow createRow(Map<String, dynamic> data) => TrainersViewRow(data);
}

class TrainersViewRow extends SupabaseDataRow {
  TrainersViewRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => TrainersViewTable();
