...
class TrainingsMarketTable extends SupabaseTable<TrainingsMarketRow> {
  @override
  String get tableName => 'trainingsMarket';

  @override
  TrainingsMarketRow createRow(Map<String, dynamic> data) =>
      TrainingsMarketRow(data);
}

class TrainingsMarketRow extends SupabaseDataRow {
  TrainingsMarketRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => TrainingsMarketTable();
