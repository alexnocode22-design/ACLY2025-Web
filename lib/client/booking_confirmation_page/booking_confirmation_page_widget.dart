...
class BookingConfirmationPageWidget extends StatefulWidget {
  const BookingConfirmationPageWidget({
    super.key,
...
class _BookingConfirmationPageWidgetState
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      safeSetState(() {});
      _model.getRecentBookings = await TrainingsBoughtTable().queryRows(
        queryFn: (q) => q
            .eqOrNull(
              'user_id',
              currentUserUid,
      ...
      _model.recentBookings =
          _model.getRecentBookings!.toList().cast<TrainingsBoughtRow>();
                              ...
                              child: FutureBuilder<List<TrainingsBoughtRow>>(
                                  ...
                                  queryFn: (q) => q
                                      ...
                                      .gteOrNull(
                                        ...
                                        supaSerialize<DateTime>(
                                            functions.todayStartUtc()),
                                      )
                                      .lteOrNull(
                                        'created_at',
                                        supaSerialize<DateTime>(
                                            functions.todayEndUtc()),
                                      )
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<TrainingsBoughtRow>
                                      listViewTrainingsBoughtRowList =
                                      snapshot.data!;
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemCount:
                                        listViewTrainingsBoughtRowList.length,
                                    itemBuilder: (context, listViewIndex) {
                                      final listViewTrainingsBoughtRow =
                                          listViewTrainingsBoughtRowList[
                                              listViewIndex];
                                      return Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                      ...
                      children: [
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                context.goNamed(ClientPokupkiWidget.routeName);
                              },
                              child: Container(
                        ...
                        Align(
                          ...
                          child: InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              context.goNamed(ClientMainWidget.routeName);
                            },
                            child: Container(
                              width: double.infinity,
                              height: 48.0,
