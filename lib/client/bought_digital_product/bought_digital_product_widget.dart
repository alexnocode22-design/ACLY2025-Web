...
import 'bought_digital_product_model.dart';
export 'bought_digital_product_model.dart';

class BoughtDigitalProductWidget extends StatefulWidget {
  const BoughtDigitalProductWidget({
    super.key,
  ...
  static String routeName = 'BoughtDigitalProduct';
  static String routePath = 'boughtDigitalProduct';

  @override
  State<BoughtDigitalProductWidget> createState() =>
      _BoughtDigitalProductWidgetState();
}

class _BoughtDigitalProductWidgetState extends State<BoughtDigitalProductWidget>
    with TickerProviderStateMixin {
  late BoughtDigitalProductModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BoughtDigitalProductModel());
    ...
    return FutureBuilder<List<DigitalProductMarketRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<DigitalProductMarketRow>
            boughtDigitalProductDigitalProductMarketRowList = snapshot.data!;

        final boughtDigitalProductDigitalProductMarketRow =
            boughtDigitalProductDigitalProductMarketRowList.isNotEmpty
                ? boughtDigitalProductDigitalProductMarketRowList.first
                : null;
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  valueOrDefault<String>(
                                    boughtDigitalProductDigitalProductMarketRow
                                        ?.digitalProductName,
                                    'Нет названия',
                                  ).maybeHandleOverflow(
                                    maxChars: 30,
