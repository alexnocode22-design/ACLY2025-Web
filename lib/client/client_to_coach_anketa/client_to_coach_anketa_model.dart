...
import 'client_to_coach_anketa_widget.dart' show ClientToCoachAnketaWidget;
import 'package:flutter/material.dart';

class ClientToCoachAnketaModel
    extends FlutterFlowModel<ClientToCoachAnketaWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey = GlobalKey<FormState>();
  // Stores action output result for [Backend Call - Query Rows] action in ClientToCoachAnketa widget.
  List<ChatMessagesRow>? checkUnreadMessagesTrainer1;
  // Model for AppBarCoachCANDIDATE component.
  late AppBarCoachCANDIDATEModel appBarCoachCANDIDATEModel;
  ...
  bool isDataUploading_uploadVideoCandidate = false;
  FFUploadedFile uploadedLocalFile_uploadVideoCandidate =
      FFUploadedFile(bytes: Uint8List.fromList([]), originalFilename: '');
  String uploadedFileUrl_uploadVideoCandidate = '';

  // Stores action output result for [Backend Call - Update Row(s)] action in UploadCoachPassport widget.
  List<TrainerProfileRow>? videoUploadedCandidate;
  // Model for TapBarTrainer component.
  late TapBarTrainerModel tapBarTrainerModel;

  @override
  void initState(BuildContext context) {
    appBarCoachCANDIDATEModel =
        createModel(context, () => AppBarCoachCANDIDATEModel());
    coachNameTextFieldTextControllerValidator =
  ...
  @override
  void dispose() {
    appBarCoachCANDIDATEModel.dispose();
