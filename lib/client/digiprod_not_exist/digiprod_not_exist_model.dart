...
import 'digiprod_not_exist_widget.dart' show DigiprodNotExistWidget;
import 'package:flutter/material.dart';

class DigiprodNotExistModel extends FlutterFlowModel<DigiprodNotExistWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in DigiprodNotExist widget.
