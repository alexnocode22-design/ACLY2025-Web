...
import 'main_info_nutrition_plan_model.dart';
export 'main_info_nutrition_plan_model.dart';

class MainInfoNutritionPlanWidget extends StatefulWidget {
  const MainInfoNutritionPlanWidget({
    super.key,
  ...
  static String routeName = 'MainInfoNutritionPlan';
  static String routePath = 'mainInfoNutritionPlan';

  @override
  State<MainInfoNutritionPlanWidget> createState() =>
      _MainInfoNutritionPlanWidgetState();
}

class _MainInfoNutritionPlanWidgetState
    extends State<MainInfoNutritionPlanWidget> with TickerProviderStateMixin {
  late MainInfoNutritionPlanModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainInfoNutritionPlanModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<CombinedNutritionplansViewRow>>(
      future: CombinedNutritionplansViewTable().querySingleRow(
        queryFn: (q) => q.eqOrNull(
          'id',
          widget.productID,
        ),
      ...
      builder: (context, snapshot) {
        ...
        List<CombinedNutritionplansViewRow>
            mainInfoNutritionPlanCombinedNutritionplansViewRowList =
            snapshot.data!;

        final mainInfoNutritionPlanCombinedNutritionplansViewRow =
            mainInfoNutritionPlanCombinedNutritionplansViewRowList.isNotEmpty
                ? mainInfoNutritionPlanCombinedNutritionplansViewRowList.first
                : null;
                                                                ...
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                    if (functions.isFavouriteNutritionPlanInList(
                                                                        mainInfoNutritionPlanCombinedNutritionplansViewRow!
                                                                            .id!,
                                                                        _model
                                                                      ...
                                                                      Align(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                                () async {
                                                                              while (_model.count < _model.nutritionPlanFavourites.length) {
                                                                                if (mainInfoNutritionPlanCombinedNutritionplansViewRow.id == _model.nutritionPlanFavourites.elementAtOrNull(_model.count)?.nutritionplanId) {
                                                                                  _model.removeAtIndexFromNutritionPlanFavourites(_model.count);
                                                                                  safeSetState(() {});
                                                                                  await FavouriteNutritionplanTable().delete(
                                                                                    matchingRows: (rows) => rows
                                                                                        .eqOrNull(
                                                                                          'nutritionplan_id',
                                                                                          mainInfoNutritionPlanCombinedNutritionplansViewRow.id,
                                                                                        )
                                                                                        .eqOrNull(
                                                                                          'user_id',
                                                                                          currentUserUid,
                                                                      ...
                                                                      Align(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                                () async {
                                                                              _model.newNutritionFavoritePlansResult = await FavouriteNutritionplanTable().insert({
                                                                                'user_id': currentUserUid,
                                                                                'nutritionplan_id': mainInfoNutritionPlanCombinedNutritionplansViewRow.id,
                                                                              });
                                                                              _model.addToNutritionPlanFavourites(_model.newNutritionFavoritePlansResult!);
                                                                              safeSetState(() {});
