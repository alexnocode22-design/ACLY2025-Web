...
import 'main_info_training_plan_model.dart';
export 'main_info_training_plan_model.dart';

class MainInfoTrainingPlanWidget extends StatefulWidget {
  const MainInfoTrainingPlanWidget({
    super.key,
  ...
  static String routeName = 'MainInfoTrainingPlan';
  static String routePath = 'mainInfoTrainingPlan';

  @override
  State<MainInfoTrainingPlanWidget> createState() =>
      _MainInfoTrainingPlanWidgetState();
}

class _MainInfoTrainingPlanWidgetState extends State<MainInfoTrainingPlanWidget>
    with TickerProviderStateMixin {
  late MainInfoTrainingPlanModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainInfoTrainingPlanModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<CombinedTrainingplansViewRow>>(
      future: CombinedTrainingplansViewTable().querySingleRow(
        queryFn: (q) => q.eqOrNull(
          'id',
          widget.productID,
        ),
      ...
      builder: (context, snapshot) {
        ...
        List<CombinedTrainingplansViewRow>
            mainInfoTrainingPlanCombinedTrainingplansViewRowList =
            snapshot.data!;

        final mainInfoTrainingPlanCombinedTrainingplansViewRow =
            mainInfoTrainingPlanCombinedTrainingplansViewRowList.isNotEmpty
                ? mainInfoTrainingPlanCombinedTrainingplansViewRowList.first
                : null;
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                16.0, 20.0, 16.0, 0.0),
                            child: FutureBuilder<List<TrainingPlanMarketRow>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<TrainingPlanMarketRow>
                                    photoContainerTrainingPlanMarketRowList =
                                    snapshot.data!;

                                final photoContainerTrainingPlanMarketRow =
                                    photoContainerTrainingPlanMarketRowList
                                            .isNotEmpty
                                        ? photoContainerTrainingPlanMarketRowList
                                            .first
                                ...
                                return Container(
                                  ...
                                  child: Builder(
                                    builder: (context) {
                                      final trainingPlanPhoto =
                                          photoContainerTrainingPlanMarketRow
                                                  ?.trainingPlanPhoto
                                                  .toList() ??
                                              [];
                                            ...
                                            Padding(
                                              ...
                                              child: PageView.builder(
                                                ...
                                                scrollDirection:
                                                    Axis.horizontal,
                                                itemCount:
                                                    trainingPlanPhoto.length,
                                                itemBuilder: (context,
                                                    trainingPlanPhotoIndex) {
                                                  final trainingPlanPhotoItem =
                                                      trainingPlanPhoto[
                                                          trainingPlanPhotoIndex];
                                                  return Align(
                                                    alignment:
                                                                ...
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                    if (functions.isFavouriteTrainingPlanInList(
                                                                        mainInfoTrainingPlanCombinedTrainingplansViewRow!
                                                                            .id!,
                                                                        _model
                                                                      ...
                                                                      Align(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                                () async {
                                                                              while (_model.count < _model.trainingPlanFavourites.length) {
                                                                                if (mainInfoTrainingPlanCombinedTrainingplansViewRow.id == _model.trainingPlanFavourites.elementAtOrNull(_model.count)?.trainingplanId) {
                                                                                  _model.removeAtIndexFromTrainingPlanFavourites(_model.count);
                                                                                  safeSetState(() {});
                                                                                  await FavouriteTrainingPlansTable().delete(
                                                                                    matchingRows: (rows) => rows
                                                                                        .eqOrNull(
                                                                                          'trainingplan_id',
                                                                                          mainInfoTrainingPlanCombinedTrainingplansViewRow.id,
                                                                                        )
                                                                                        .eqOrNull(
                                                                                          'user_id',
                                                                                          currentUserUid,
                                                                      ...
                                                                      Align(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                                () async {
                                                                              _model.newFavoriteTrainingPlansResult = await FavouriteTrainingPlansTable().insert({
                                                                                'user_id': currentUserUid,
                                                                                'trainingplan_id': mainInfoTrainingPlanCombinedTrainingplansViewRow.id,
                                                                              });
                                                                              _model.addToTrainingPlanFavourites(_model.newFavoriteTrainingPlansResult!);
                                                                              safeSetState(() {});
