...
import 'nutrition_plan_not_exist_widget.dart' show NutritionPlanNotExistWidget;
import 'package:flutter/material.dart';

class NutritionPlanNotExistModel
    extends FlutterFlowModel<NutritionPlanNotExistWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in NutritionPlanNotExist widget.
