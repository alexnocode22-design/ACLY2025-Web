...
import 'training_not_exist_widget.dart' show TrainingNotExistWidget;
import 'package:flutter/material.dart';

class TrainingNotExistModel extends FlutterFlowModel<TrainingNotExistWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in TrainingNotExist widget.
