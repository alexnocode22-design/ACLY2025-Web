...
import 'app_bar_client_chat_model.dart';
export 'app_bar_client_chat_model.dart';

class AppBarClientChatWidget extends StatefulWidget {
  const AppBarClientChatWidget({super.key});

  @override
  State<AppBarClientChatWidget> createState() => _AppBarClientChatWidgetState();
}

class _AppBarClientChatWidgetState extends State<AppBarClientChatWidget> {
  late AppBarClientChatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppBarClientChatModel());
