...
import 'app_bar_client_chat_with_trainer_model.dart';
export 'app_bar_client_chat_with_trainer_model.dart';

class AppBarClientChatWithTrainerWidget extends StatefulWidget {
  const AppBarClientChatWithTrainerWidget({
    super.key,
    this.userID,
  });
  ...
  @override
  State<AppBarClientChatWithTrainerWidget> createState() =>
      _AppBarClientChatWithTrainerWidgetState();
}

class _AppBarClientChatWithTrainerWidgetState
    extends State<AppBarClientChatWithTrainerWidget> {
  late AppBarClientChatWithTrainerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppBarClientChatWithTrainerModel());
