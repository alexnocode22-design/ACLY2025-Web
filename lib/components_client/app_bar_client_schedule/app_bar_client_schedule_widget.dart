...
import 'app_bar_client_schedule_model.dart';
export 'app_bar_client_schedule_model.dart';

class AppBarClientScheduleWidget extends StatefulWidget {
  const AppBarClientScheduleWidget({super.key});

  @override
  State<AppBarClientScheduleWidget> createState() =>
      _AppBarClientScheduleWidgetState();
}

class _AppBarClientScheduleWidgetState
    extends State<AppBarClientScheduleWidget> {
  late AppBarClientScheduleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppBarClientScheduleModel());
