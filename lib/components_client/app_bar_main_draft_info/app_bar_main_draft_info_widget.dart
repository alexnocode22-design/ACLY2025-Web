...
import 'app_bar_main_draft_info_model.dart';
export 'app_bar_main_draft_info_model.dart';

class AppBarMainDraftInfoWidget extends StatefulWidget {
  const AppBarMainDraftInfoWidget({super.key});

  @override
  State<AppBarMainDraftInfoWidget> createState() =>
      _AppBarMainDraftInfoWidgetState();
}

class _AppBarMainDraftInfoWidgetState extends State<AppBarMainDraftInfoWidget> {
  late AppBarMainDraftInfoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppBarMainDraftInfoModel());
                  ...
                  child: Padding(
                    ...
                    child: FutureBuilder<List<UserProfileRow>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<UserProfileRow> clientContainerUserProfileRowList =
                            snapshot.data!;

                        final clientContainerUserProfileRow =
                            clientContainerUserProfileRowList.isNotEmpty
                                ? clientContainerUserProfileRowList.first
                                : null;
