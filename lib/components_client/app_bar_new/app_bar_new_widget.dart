...
import 'app_bar_new_model.dart';
export 'app_bar_new_model.dart';

class AppBarNewWidget extends StatefulWidget {
  const AppBarNewWidget({super.key});

  @override
  State<AppBarNewWidget> createState() => _AppBarNewWidgetState();
}
                        ...
                        children: [
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              highlightColor: Colors.transparent,
                              onTap: () async {
                                context.pushNamed(CoachSalesWidget.routeName);
                              },
                              child: ClipRRect(
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: FutureBuilder<
                                ...
                                future: CombinedUserTrainerViewTable()
                                    .querySingleRow(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<CombinedUserTrainerViewRow>
                                      stackCombinedUserTrainerViewRowList =
                                      snapshot.data!;

                                  final stackCombinedUserTrainerViewRow =
                                      stackCombinedUserTrainerViewRowList
                                              .isNotEmpty
                                          ? stackCombinedUserTrainerViewRowList
                                              .first
                                        ...
                                        child: Container(
                                          ...
                                          child: Image.network(
                                            valueOrDefault<String>(
                                              stackCombinedUserTrainerViewRow
                                                  ?.userPhoto,
