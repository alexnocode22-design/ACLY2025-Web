...
import 'app_bar_profile_model.dart';
export 'app_bar_profile_model.dart';
...
class _AppBarProfileWidgetState extends State<AppBarProfileWidget> {
  late AppBarProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppBarProfileModel());
