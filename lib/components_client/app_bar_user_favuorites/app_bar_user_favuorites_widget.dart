...
import 'app_bar_user_favuorites_model.dart';
export 'app_bar_user_favuorites_model.dart';

class AppBarUserFavuoritesWidget extends StatefulWidget {
  const AppBarUserFavuoritesWidget({super.key});

  @override
  State<AppBarUserFavuoritesWidget> createState() =>
      _AppBarUserFavuoritesWidgetState();
}

class _AppBarUserFavuoritesWidgetState
    extends State<AppBarUserFavuoritesWidget> {
  late AppBarUserFavuoritesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppBarUserFavuoritesModel());
