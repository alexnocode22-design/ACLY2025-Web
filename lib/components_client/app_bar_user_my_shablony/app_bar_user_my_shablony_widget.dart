...
import 'app_bar_user_my_shablony_model.dart';
export 'app_bar_user_my_shablony_model.dart';

class AppBarUserMyShablonyWidget extends StatefulWidget {
  const AppBarUserMyShablonyWidget({super.key});

  @override
  State<AppBarUserMyShablonyWidget> createState() =>
      _AppBarUserMyShablonyWidgetState();
}

class _AppBarUserMyShablonyWidgetState
    extends State<AppBarUserMyShablonyWidget> {
  late AppBarUserMyShablonyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppBarUserMyShablonyModel());
