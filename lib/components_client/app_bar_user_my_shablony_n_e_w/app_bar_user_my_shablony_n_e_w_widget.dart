...
import 'app_bar_user_my_shablony_n_e_w_model.dart';
export 'app_bar_user_my_shablony_n_e_w_model.dart';

class AppBarUserMyShablonyNEWWidget extends StatefulWidget {
  const AppBarUserMyShablonyNEWWidget({super.key});

  @override
  State<AppBarUserMyShablonyNEWWidget> createState() =>
      _AppBarUserMyShablonyNEWWidgetState();
}

class _AppBarUserMyShablonyNEWWidgetState
    extends State<AppBarUserMyShablonyNEWWidget> {
  late AppBarUserMyShablonyNEWModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppBarUserMyShablonyNEWModel());
            ...
            child: Row(
              ...
              children: [
                InkWell(
                  ...
                  onTap: () async {
                    context.pushNamed(ClientShablonySavedWidget.routeName);
                  },
                  child: Container(
                    decoration: BoxDecoration(),
                    child: Padding(
