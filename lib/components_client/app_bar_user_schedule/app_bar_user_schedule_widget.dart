...
import 'app_bar_user_schedule_model.dart';
export 'app_bar_user_schedule_model.dart';

class AppBarUserScheduleWidget extends StatefulWidget {
  const AppBarUserScheduleWidget({super.key});

  @override
  State<AppBarUserScheduleWidget> createState() =>
      _AppBarUserScheduleWidgetState();
}

class _AppBarUserScheduleWidgetState extends State<AppBarUserScheduleWidget> {
  late AppBarUserScheduleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppBarUserScheduleModel());
