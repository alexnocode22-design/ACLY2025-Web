...
import 'app_bar_user_shablony_empty_model.dart';
export 'app_bar_user_shablony_empty_model.dart';

class AppBarUserShablonyEmptyWidget extends StatefulWidget {
  const AppBarUserShablonyEmptyWidget({super.key});

  @override
  State<AppBarUserShablonyEmptyWidget> createState() =>
      _AppBarUserShablonyEmptyWidgetState();
}

class _AppBarUserShablonyEmptyWidgetState
    extends State<AppBarUserShablonyEmptyWidget> {
  late AppBarUserShablonyEmptyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppBarUserShablonyEmptyModel());
