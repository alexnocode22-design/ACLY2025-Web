...
import 'app_bar_user_shablony_new_model.dart';
export 'app_bar_user_shablony_new_model.dart';

class AppBarUserShablonyNewWidget extends StatefulWidget {
  const AppBarUserShablonyNewWidget({super.key});

  @override
  State<AppBarUserShablonyNewWidget> createState() =>
      _AppBarUserShablonyNewWidgetState();
}

class _AppBarUserShablonyNewWidgetState
    extends State<AppBarUserShablonyNewWidget> {
  late AppBarUserShablonyNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppBarUserShablonyNewModel());
