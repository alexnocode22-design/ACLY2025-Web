...
import 'app_bar_coach_model.dart';
export 'app_bar_coach_model.dart';

class AppBarCoachWidget extends StatefulWidget {
  const AppBarCoachWidget({super.key});

  @override
  State<AppBarCoachWidget> createState() => _AppBarCoachWidgetState();
}

class _AppBarCoachWidgetState extends State<AppBarCoachWidget> {
  late AppBarCoachModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppBarCoachModel());
