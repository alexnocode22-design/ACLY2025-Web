...
import 'app_bar_coach_chat_model.dart';
export 'app_bar_coach_chat_model.dart';

class AppBarCoachChatWidget extends StatefulWidget {
  const AppBarCoachChatWidget({super.key});

  @override
  State<AppBarCoachChatWidget> createState() => _AppBarCoachChatWidgetState();
}

class _AppBarCoachChatWidgetState extends State<AppBarCoachChatWidget> {
  late AppBarCoachChatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppBarCoachChatModel());
