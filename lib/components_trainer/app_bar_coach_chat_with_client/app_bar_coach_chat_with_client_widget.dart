...
import 'app_bar_coach_chat_with_client_model.dart';
export 'app_bar_coach_chat_with_client_model.dart';

class AppBarCoachChatWithClientWidget extends StatefulWidget {
  const AppBarCoachChatWithClientWidget({
    super.key,
    this.userID,
  });
  ...
  @override
  State<AppBarCoachChatWithClientWidget> createState() =>
      _AppBarCoachChatWithClientWidgetState();
}

class _AppBarCoachChatWithClientWidgetState
    extends State<AppBarCoachChatWithClientWidget> {
  late AppBarCoachChatWithClientModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppBarCoachChatWithClientModel());
