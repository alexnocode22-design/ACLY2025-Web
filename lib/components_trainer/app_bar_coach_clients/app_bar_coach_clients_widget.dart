...
import 'app_bar_coach_clients_model.dart';
export 'app_bar_coach_clients_model.dart';

class AppBarCoachClientsWidget extends StatefulWidget {
  const AppBarCoachClientsWidget({super.key});

  @override
  State<AppBarCoachClientsWidget> createState() =>
      _AppBarCoachClientsWidgetState();
}

class _AppBarCoachClientsWidgetState extends State<AppBarCoachClientsWidget> {
  late AppBarCoachClientsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppBarCoachClientsModel());
