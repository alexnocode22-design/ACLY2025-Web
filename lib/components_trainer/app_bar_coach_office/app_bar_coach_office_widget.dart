...
import '/components_trainer/dropdown_coach/dropdown_coach_widget.dart';
...
import 'app_bar_coach_office_model.dart';
export 'app_bar_coach_office_model.dart';

class AppBarCoachOfficeWidget extends StatefulWidget {
  const AppBarCoachOfficeWidget({
    super.key,
    required this.useID,
  });
  ...
  @override
  State<AppBarCoachOfficeWidget> createState() =>
      _AppBarCoachOfficeWidgetState();
}

class _AppBarCoachOfficeWidgetState extends State<AppBarCoachOfficeWidget> {
  late AppBarCoachOfficeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppBarCoachOfficeModel());
            ...
            child: Row(
              ...
              children: [
                InkWell(
                  ...
                  onTap: () async {
                    context.pushNamed(CoachAnketaWidget.routeName);
                  },
                  child: Container(
                    decoration: BoxDecoration(),
                    child: Padding(
