...
import 'app_bar_coach_products_model.dart';
export 'app_bar_coach_products_model.dart';

class AppBarCoachProductsWidget extends StatefulWidget {
  const AppBarCoachProductsWidget({super.key});

  @override
  State<AppBarCoachProductsWidget> createState() =>
      _AppBarCoachProductsWidgetState();
}

class _AppBarCoachProductsWidgetState extends State<AppBarCoachProductsWidget> {
  late AppBarCoachProductsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppBarCoachProductsModel());
