...
import 'app_bar_coach_reviews_model.dart';
export 'app_bar_coach_reviews_model.dart';

class AppBarCoachReviewsWidget extends StatefulWidget {
  const AppBarCoachReviewsWidget({super.key});

  @override
  State<AppBarCoachReviewsWidget> createState() =>
      _AppBarCoachReviewsWidgetState();
}

class _AppBarCoachReviewsWidgetState extends State<AppBarCoachReviewsWidget> {
  late AppBarCoachReviewsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppBarCoachReviewsModel());
