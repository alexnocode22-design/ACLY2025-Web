...
import 'app_bar_coach_reviews_replay_model.dart';
export 'app_bar_coach_reviews_replay_model.dart';

class AppBarCoachReviewsReplayWidget extends StatefulWidget {
  const AppBarCoachReviewsReplayWidget({super.key});

  @override
  State<AppBarCoachReviewsReplayWidget> createState() =>
      _AppBarCoachReviewsReplayWidgetState();
}

class _AppBarCoachReviewsReplayWidgetState
    extends State<AppBarCoachReviewsReplayWidget> {
  late AppBarCoachReviewsReplayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppBarCoachReviewsReplayModel());
