...
import 'app_bar_coach_sales_model.dart';
export 'app_bar_coach_sales_model.dart';

class AppBarCoachSalesWidget extends StatefulWidget {
  const AppBarCoachSalesWidget({super.key});

  @override
  State<AppBarCoachSalesWidget> createState() => _AppBarCoachSalesWidgetState();
}

class _AppBarCoachSalesWidgetState extends State<AppBarCoachSalesWidget> {
  late AppBarCoachSalesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppBarCoachSalesModel());
