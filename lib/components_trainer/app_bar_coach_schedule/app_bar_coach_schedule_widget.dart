...
import 'app_bar_coach_schedule_model.dart';
export 'app_bar_coach_schedule_model.dart';

class AppBarCoachScheduleWidget extends StatefulWidget {
  const AppBarCoachScheduleWidget({super.key});

  @override
  State<AppBarCoachScheduleWidget> createState() =>
      _AppBarCoachScheduleWidgetState();
}

class _AppBarCoachScheduleWidgetState extends State<AppBarCoachScheduleWidget> {
  late AppBarCoachScheduleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppBarCoachScheduleModel());
