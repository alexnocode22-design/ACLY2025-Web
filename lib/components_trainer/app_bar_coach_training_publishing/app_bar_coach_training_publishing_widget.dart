...
import 'app_bar_coach_training_publishing_model.dart';
export 'app_bar_coach_training_publishing_model.dart';

class AppBarCoachTrainingPublishingWidget extends StatefulWidget {
  const AppBarCoachTrainingPublishingWidget({super.key});

  @override
  State<AppBarCoachTrainingPublishingWidget> createState() =>
      _AppBarCoachTrainingPublishingWidgetState();
}

class _AppBarCoachTrainingPublishingWidgetState
    extends State<AppBarCoachTrainingPublishingWidget> {
  late AppBarCoachTrainingPublishingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppBarCoachTrainingPublishingModel());
