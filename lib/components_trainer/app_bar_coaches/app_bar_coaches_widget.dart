...
import 'app_bar_coaches_model.dart';
export 'app_bar_coaches_model.dart';

class AppBarCoachesWidget extends StatefulWidget {
  const AppBarCoachesWidget({super.key});

  @override
  State<AppBarCoachesWidget> createState() => _AppBarCoachesWidgetState();
}

class _AppBarCoachesWidgetState extends State<AppBarCoachesWidget> {
  late AppBarCoachesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppBarCoachesModel());
