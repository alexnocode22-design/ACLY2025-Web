...
import 'app_bar_new_training_model.dart';
export 'app_bar_new_training_model.dart';

class AppBarNewTrainingWidget extends StatefulWidget {
  const AppBarNewTrainingWidget({super.key});

  @override
  State<AppBarNewTrainingWidget> createState() =>
      _AppBarNewTrainingWidgetState();
}

class _AppBarNewTrainingWidgetState extends State<AppBarNewTrainingWidget> {
  late AppBarNewTrainingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppBarNewTrainingModel());
