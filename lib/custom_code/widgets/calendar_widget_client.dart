...
/// CalendarWidgetClient - A custom Flutter widget that displays an
/// interactive calendar with support for booked dates, visual animations, and
/// date selection.
///
...
class CalendarWidgetClient extends StatefulWidget {
  ...
  @override
  State<CalendarWidgetClient> createState() => _CalendarWidgetClientState();
}

/// State class for CalendarWidgetClient that manages calendar interactions,
/// animations, and visual styling
class _CalendarWidgetClientState extends State<CalendarWidgetClient>
  ...
  @override
  void didUpdateWidget(CalendarWidgetClient oldWidget) {
