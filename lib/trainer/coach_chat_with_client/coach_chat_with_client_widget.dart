...
import 'coach_chat_with_client_model.dart';
export 'coach_chat_with_client_model.dart';

class CoachChatWithClientWidget extends StatefulWidget {
  const CoachChatWithClientWidget({
    super.key,
  ...
  static String routeName = 'CoachChatWithClient';
  static String routePath = 'coachChatWithClient';

  @override
  State<CoachChatWithClientWidget> createState() =>
      _CoachChatWithClientWidgetState();
}

class _CoachChatWithClientWidgetState extends State<CoachChatWithClientWidget> {
  late CoachChatWithClientModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CoachChatWithClientModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.memberData = await UserProfileTable().queryRows(
        queryFn: (q) => q.inFilterOrNull(
          'user_id',
          widget.chatMembers,
        ),
      );
      _model.coachChatWithClient = await ChatMessagesTable().queryRows(
          ...
          child: Stack(
            children: [
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: StreamBuilder<List<ChatMessagesRow>>(
                              stream: _model
                                      .chatWithClientListViewSupabaseStream ??=
                                  SupaFlow.client
                                      .from("chat_messages")
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<ChatMessagesRow>
                                    chatWithClientListViewChatMessagesRowList =
                                    snapshot.data!;
                                ...
                                return ListView.separated(
                                  ...
                                  itemBuilder:
                                      (context, chatWithClientListViewIndex) {
                                    final chatWithClientListViewChatMessagesRow =
                                        chatWithClientListViewChatMessagesRowList[
                                            chatWithClientListViewIndex];
                                    return Builder(
                                      builder: (context) {
                                        if (chatWithClientListViewChatMessagesRow
                                                .createdbyId ==
                                            currentUserUid) {
                                          return Align(
                                            alignment:
                                                                ...
                                                                child: Image
                                                                  ...
                                                                  valueOrDefault<
                                                                    ...
                                                                    _model
                                                                        .memberData
                                                                        ?.where((e) =>
                                                                            chatWithClientListViewChatMessagesRow.createdbyId ==
                                                                            e.userId)
                                                                        .toList()
                                                                        .firstOrNull
                                                                        ?.userPhoto,
                                                              ...
                                                              child: Text(
                                                                valueOrDefault<
                                                                  ...
                                                                  _model
                                                                      .memberData
                                                                      ?.where((e) =>
                                                                          chatWithClientListViewChatMessagesRow
                                                                              .createdbyId ==
                                                                          e.userId)
                                                                      .toList()
                                                                      .firstOrNull
                                  ...
                                  controller: _model
                                      .chatWithClientListViewScrollController,
                                );
                              },
                            ),
                          ),
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  onChanged: (_) => EasyDebounce.debounce(
                                    '_model.chatReplayTextController',
              ...
              Align(
                alignment: AlignmentDirectional(0.0, -1.0),
                child: wrapWithModel(
                  model: _model.appBarCoachChatWithClientModel,
