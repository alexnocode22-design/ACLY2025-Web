...
import 'coach_chats_model.dart';
export 'coach_chats_model.dart';

class CoachChatsWidget extends StatefulWidget {
  const CoachChatsWidget({
    super.key,
    String? userID,
  }) : this.userID = userID ?? '';
  ...
  static String routeName = 'CoachChats';
  static String routePath = 'coachChats';

  @override
  State<CoachChatsWidget> createState() => _CoachChatsWidgetState();
}

class _CoachChatsWidgetState extends State<CoachChatsWidget> {
  late CoachChatsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CoachChatsModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().tabIconColor = 3;
      safeSetState(() {});
      _model.checkUnreadMessagesTrainerChats =
      ...
      if (_model.checkUnreadMessagesTrainerChats!.length < 1) {
            ...
            child: Stack(
              children: [
                                                      ...
                                                      child: FutureBuilder<
                                                        ...
                                                        builder: (context,
                                                          ...
                                                          List<ClientAllproductsViewRow>
                                                              textClientAllproductsViewRowList =
                                                              snapshot.data!;
                ...
                Align(
                  ...
                  child: wrapWithModel(
                    model: _model.appBarCoachChatModel,
                    updateCallback: () => safeSetState(() {}),
                    child: AppBarCoachChatWidget(),
                  ),
                ),
              ],
            ),
